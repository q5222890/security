...
public class FileCache {
    ...
    public FileCache(Context context) {
        ...
        if (android.os.Environment.getExternalStorageState().equals(android.os.Environment.MEDIA_MOUNTED)) { //判断sd卡可读写
            cacheDir = new File(
                    android.os.Environment.getExternalStorageDirectory(),
                    "com_wen_security_cache");  // /mnt/sdcard外置sd卡根目录
        }else {
            cacheDir = context.getCacheDir();
            Log.i("------------","cacheDir: "+cacheDir.getAbsolutePath());
