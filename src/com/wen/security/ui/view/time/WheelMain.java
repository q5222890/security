package com.wen.security.ui.view.time;
...
public class WheelMain {
    ...
    public WheelMain(Activity context,int year, int month, int day) {
        LayoutInflater inflater = LayoutInflater.from(context);
        this.view = inflater.inflate(R.layout.timepicker, null);
        ScreenInfo screenInfo = new ScreenInfo(context);
        this.screenheight = screenInfo.getHeight();
        initDateTimePicker(year, month, day);
    }
    
    public WheelMain(Activity context) {
        this(context, 0, 0, 0);
    }
